...
# import all views
from . views                            import (RegisterAPIView, TaskViewSet, archive_or_activate_task, NoteViewSet, get_all_tasks, get_all_notes, get_all_users, set_as_admin, set_as_normal_user)
